...
file_path = "E:\smo\Spider-monkey-optimization-master\smooutput.json"  # Replace with your JSON file path
...
class Particle:
    ...
    def evaluate(self,objective_function):
        self.fitness_particle_position=objective_function(data)
        if mm == -1:
